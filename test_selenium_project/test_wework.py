...
class TestSelenium:
    def setup(self):
        ...
        self.driver.get(url)
        cookies={
            "wwrtx.vst": "IuKs_WFzuLKpGesP25hShWnoajxBs-CnpzxL7Vw9a0wYNdj_ANKSKfbMcP5LUOCmJKVa5CJIst6HXiUsdlG9Bu-lsrtQ0RSx14Vb3IiAnucIXEdJTikFlLshU3dyEHSjt8jOhX9DY9ct_bIZTta567YTaPGF89w3NJkF4f2jEPaDC_P-f7OVx4D1e54kaJ8duhlToCdNPFz-Y4aIx2Ol5LIDrc9bDrTvY5STRrK28q33oczyGmbn2VwiQNZRM_LM0LeFjW5K9k_SMCY-GjEpMQ",
            "wwrtx.d2st": "a2486739",
            "wwrtx.sid": "2FOCjQY_keCkzlKilbwZsUQzWu-m2uXGr3alfwJcSlCXOsE4Se_JQQo8xbfuH_Qs",
            "wwrtx.ltype": "1",
            "wxpay.corpid": "1970325037081458",
            "wxpay.vid": "1688851323387970",
        }
